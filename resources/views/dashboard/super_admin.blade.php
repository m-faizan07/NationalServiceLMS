...
@section('content')
<div class="row mb-5 gy-4" style="padding-top: 0px !important;">
    <div class="col-xxl-12 col-md-12 col-12 dash-info-card super-admin">
        <div class="info-card-inner card mb-0" style="background:none !important;">
            <div class="d-flex justify-content-between">
                <div class="info-icon-wrp d-flex flex-wrap align-items-start gap-2">
                    <div class="card-label" style="padding: 5px 5px !important;margin-top:10px;"></div>
                    <h3>Control Center</h3>
                </div>
                <div class="info-icon-wrp d-flex flex-wrap align-items-start gap-2">
                    <div class="card p-2">Active users: 2,487</div>
                    <div class="card p-2">System Health: 98.5%</div>
                </div>
            </div>
            <div class="info-content d-flex align-items-center gap-3 flex-wrap">
                <span class="mb-0" style="margin-top: -22px;">National Service Management Dashboard</span>
            </div>
        </div>
    </div>
</div>
...
<div class="row mb-5 gy-4">
    <h3 class="mt-0 pt-0">Applicant Screening & Interview Process</h3>
    <span class="mt-0">Track the progress of student applications from submission to interview outcome</span>
    <div class="col-xxl-3 col-md-6 col-12 dash-info-card super-admin">
        <div class="info-card-inner card mb-0" style="background:none !important;">
            ...
            <div class="info-icon-wrp d-flex flex-wrap align-items-start justify-content-between gap-2 mb-3">
                ...
                <div class="card-label" style="padding: 16px 17px !important;">
                    <!-- {{ __('Submitted applications') }} -->
                </div>

                <div class="card-label" style="font-size: 11px;padding: 0px 15px !important;">
                    8%
                </div>
            </div>
            <div class="info-content d-flex align-items-center gap-3 flex-wrap">
                <h2 class="h4 mb-0 info-link" style="color:black !important;">{{ __('Total Applications') }}</h2>
    ...
    <div class="col-xxl-3 col-md-6 col-12 dash-info-card super-admin">
        <div class="info-card-inner card mb-0" style="background:none !important;">
            ...
            <div class="info-content d-flex align-items-center gap-3 flex-wrap">
                <h2 class="h4 mb-0 info-link" style="color:black !important;">{{ __('Pending Review') }}</h2>
    ...
    <div class="col-xxl-3 col-md-6 col-12 dash-info-card super-admin">
        <div class="info-card-inner card mb-0" style="background:none !important;">
            ...
            <div class="info-icon-wrp d-flex flex-wrap align-items-start justify-content-between gap-2 mb-3">
                ...
                <div class="card-label" style="padding: 16px 17px !important;background-color:#954f5b;">
                    <!-- {{ __('Successfully approved') }} -->
                </div>
                <div class="card-label" style="font-size: 11px;padding: 0px 15px !important;background-color:#954f5b;">
                    +55%
                </div>
            </div>
            <div class="info-content d-flex align-items-center gap-3 flex-wrap">
                <h2 class="h4 mb-0 info-link" style="color:black !important;">{{ __('Approved for Interview') }}</h2>
    ...
    <div class="col-xxl-3 col-md-6 col-12 dash-info-card super-admin">
        <div class="info-card-inner card mb-0" style="background:none !important;">
            ...
            <div class="info-content d-flex align-items-center gap-3 flex-wrap">
                <h2 class="h4 mb-0 info-link" style="color:black !important;">{{ __('Interview Scheduled') }}</h2>
                <h3 class="mb-0">{{ $user->total_plan }}</h3>
            </div>
        </div>
    </div>
    <div class="col-xxl-3 col-md-6 col-12 dash-info-card super-admin">
        <div class="info-card-inner card mb-0" style="background:none !important;">
            ...
            <div class="info-icon-wrp d-flex flex-wrap align-items-start justify-content-between gap-2 mb-3">
                ...
                <div class="card-label" style="padding: 16px 17px !important; background-color:rgba(88, 57, 104, 0.56) !important;">
                    <!-- {{ __('Finished interviews') }} -->
                </div>
                <div class="card-label" style="font-size: 11px;padding: 0px 15px !important;background-color:rgba(88, 57, 104, 0.56) !important;">
                    99%
                </div>
            </div>
            <div class="info-content d-flex align-items-center gap-3 flex-wrap">
                <h2 class="h4 mb-0 info-link" style="color:black !important;">{{ __('Interviews Completed') }}</h2>
                <h3 class="mb-0">{{ $user->total_plan }}</h3>
            </div>
        </div>
    </div>
    <div class="col-xxl-3 col-md-6 col-12 dash-info-card super-admin">
        <div class="info-card-inner card mb-0" style="background:none !important;">
            ...
            <div class="info-icon-wrp d-flex flex-wrap align-items-start justify-content-between gap-2 mb-3">
                ...
                <div class="card-label" style="padding: 16px 17px !important;background-color:rgba(236, 131, 66, 0.56) !important;">
                    <!-- {{ __('Application rejected') }} -->
                </div>
                <div class="card-label" style="font-size: 11px;padding: 0px 15px !important;background-color:rgba(236, 131, 66, 0.56) !important;">
                    -60%
                </div>
            </div>
            <div class="info-content d-flex align-items-center gap-3 flex-wrap">
                <h2 class="h4 mb-0 info-link" style="color:black !important;">{{ __('Applications Rejected') }}</h2>
                <h3 class="mb-0">{{ $user->total_plan }}</h3>
            </div>
        </div>
    </div>
...
<div class="row mb-5 gy-4">
    <h3>National Service Training Management</h3>
    <span class="mt-0">Manage students enrolled in National Service training programs</span>
    <div class="col-xxl-3 col-md-6 col-12 dash-info-card super-admin">
        <div class="info-card-inner card mb-0" style="background:none !important;">
            <!-- <svg class="star-bg" width="83" height="79" viewBox="0 0 83 79" fill="none"
                xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="info-icon-wrp d-flex flex-wrap align-items-start justify-content-between gap-2 mb-3">
                ...
                <div class="card-label" style="padding: 16px 17px !important;background-color:rgba(57, 104, 59, 0.56) !important;">
                    <!-- {{ __('Currently running') }} -->
                </div>
                <div class="card-label" style="font-size: 11px;padding: 0px 15px !important;background-color:rgba(57, 104, 59, 0.56) !important;">
                    -10%
                </div>
            </div>
            <div class="info-content d-flex align-items-center gap-3 flex-wrap">
                <h2 class="h4 mb-0 info-link" style="color:black !important;">{{ __('Active Batches') }}</h2>
                <h3 class="mb-0">{{ $user->total_plan }}</h3>
            </div>
        </div>
    </div>
    <div class="col-xxl-3 col-md-6 col-12 dash-info-card super-admin">
        <div class="info-card-inner card mb-0" style="background:none !important;">
            ...
            <div class="info-icon-wrp d-flex flex-wrap align-items-start justify-content-between gap-2 mb-3">
                ...
                <div class="card-label" style="padding: 16px 17px !important;background-color:rgba(201, 79, 45, 0.8) !important;">
                    <!-- {{ __('Currently running') }} -->
                </div>
                <div class="card-label" style="font-size: 11px;padding: 0px 15px !important;background-color:rgba(201, 79, 45, 0.8) !important;">
                    +49%
                </div>
            </div>
            <div class="info-content d-flex align-items-center gap-3 flex-wrap">
                <h2 class="h4 mb-0 info-link" style="color:black !important;">{{ __('Std Not Reachable') }}</h2>
                <h3 class="mb-0">{{ $user->total_plan }}</h3>
            </div>
        </div>
    </div>
    <div class="col-xxl-3 col-md-6 col-12 dash-info-card super-admin">
        <div class="info-card-inner card mb-0" style="background:none !important;">
            ...
            <div class="info-icon-wrp d-flex flex-wrap align-items-start justify-content-between gap-2 mb-3">
                ...
                <div class="card-label" style="padding: 16px 17px !important;background-color:rgba(57, 104, 92, 0.56) !important;">
                    <!-- {{ __('Currently running') }} -->
                </div>
                <div class="card-label" style="font-size: 11px;padding: 0px 15px !important;background-color:rgba(57, 104, 92, 0.56) !important;">
                    89%
                </div>
            </div>
            <div class="info-content d-flex align-items-center gap-3 flex-wrap">
                <h2 class="h4 mb-0 info-link" style="color:black !important;">{{ __('Graduated Training') }}</h2>
                <h3 class="mb-0">{{ $user->total_plan }}</h3>
            </div>
        </div>
    </div>
    <div class="col-xxl-3 col-md-6 col-12 dash-info-card super-admin">
        <div class="info-card-inner card mb-0" style="background:none !important;">
            ...
            <div class="info-icon-wrp d-flex flex-wrap align-items-start justify-content-between gap-2 mb-3">
                ...
                <div class="card-label" style="padding: 16px 17px !important;background-color:rgba(201, 93, 91, 0.56) !important;">
                    <!-- {{ __('Queue for training') }} -->
                </div>
                <div class="card-label" style="font-size: 11px;padding: 0px 15px !important;background-color:rgba(201, 93, 91, 0.56) !important;">
                    67%
                </div>
            </div>
            <div class="info-content d-flex align-items-center gap-3 flex-wrap">
                <h2 class="h4 mb-0 info-link" style="color:black !important;">{{ __('Awaiting Training') }}</h2>
                <h3 class="mb-0">{{ $user->total_plan }}</h3>
            </div>
        </div>
    </div>
    <div class="col-xxl-3 col-md-6 col-12 dash-info-card super-admin">
        <div class="info-card-inner card mb-0" style="background:none !important;">
            ...
            <div class="info-icon-wrp d-flex flex-wrap align-items-start justify-content-between gap-2 mb-3">
                ...
                <div class="card-label" style="padding: 16px 17px !important;background-color:rgba(51, 187, 194, 0.56) !important;">
                    <!-- {{ __('Active training') }} -->
                </div>
                <div class="card-label" style="font-size: 11px;padding: 0px 15px !important;background-color:rgba(51, 187, 194, 0.56) !important;">
                    84%
                </div>
            </div>
            <div class="info-content d-flex align-items-center gap-3 flex-wrap">
                <h2 class="h4 mb-0 info-link" style="color:black !important;">{{ __('Currently In Training') }}</h2>
                <h3 class="mb-0">{{ $user->total_user }}</h3>
            </div>
        </div>
    </div>
    <div class="col-xxl-3 col-md-6 col-12 dash-info-card super-admin">
        <div class="info-card-inner card mb-0" style="background:none !important;">
            ...
            <div class="info-icon-wrp d-flex flex-wrap align-items-start justify-content-between gap-2 mb-3">
                ...
                <div class="card-label" style="padding: 16px 17px !important;background-color:rgba(75, 57, 104, 0.56) !important;">
                    <!-- {{ __('Training terminated') }} -->
                </div>
                <div class="card-label" style="font-size: 11px;padding: 0px 15px !important;background-color:rgba(75, 57, 104, 0.56) !important;">
                    72%
                </div>
            </div>
            <div class="info-content d-flex align-items-center gap-3 flex-wrap">
                <h2 class="h4 mb-0 info-link" style="color:black !important;">{{ __('Training Terminated') }}</h2>
                <h3 class="mb-0">{{ $user->total_orders }}</h3>
            </div>
        </div>
    </div>
...
<div class="row mb-5 gy-4">
    <h3>Post-Graduation Deployment</h3>
    <span class="mt-0">Track graduates and their assigned pathways after training</span>
    <div class="col-xxl-3 col-md-6 col-12 dash-info-card super-admin">
        <div class="info-card-inner card mb-0" style="background:none !important;">
            <!-- <svg class="star-bg" width="83" height="79" viewBox="0 0 83 79" fill="none"
                xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="info-icon-wrp d-flex flex-wrap align-items-start justify-content-between gap-2 mb-3">
                ...
                <div class="card-label" style="padding: 16px 17px !important;background-color:rgba(10, 5, 27, 0.16) !important;">
                    <!-- {{ __('Defence Force') }} -->
                </div>
                <div class="card-label" style="font-size: 11px;padding: 0px 15px !important;background-color:rgba(10, 5, 27, 0.16) !important;">
                    -2%
                </div>
            </div>
            <div class="info-content d-flex align-items-center gap-3 flex-wrap">
                <h2 class="h4 mb-0 info-link" style="color:black !important;">{{ __('Deployed to MNDF') }}</h2>
                <h3 class="mb-0">{{ $user->total_user }}</h3>
            </div>
        </div>
    </div>
    <div class="col-xxl-3 col-md-6 col-12 dash-info-card super-admin">
        <div class="info-card-inner card mb-0" style="background:none !important;">
            ...
            <div class="info-icon-wrp d-flex flex-wrap align-items-start justify-content-between gap-2 mb-3">
                ...
                <div class="card-label" style="padding: 16px 17px !important;background-color:rgba(109, 170, 56, 0.56) !important;">
                    <!-- {{ __('Police Service') }} -->
                </div>
                <div class="card-label" style="font-size: 11px;padding: 0px 15px !important;background-color:rgba(109, 170, 56, 0.56) !important;">
                    7%
                </div>
            </div>
            <div class="info-content d-flex align-items-center gap-3 flex-wrap">
                <h2 class="h4 mb-0 info-link" style="color:black !important;">{{ __('Deployed to Police') }}</h2>
                <h3 class="mb-0">{{ $user->total_orders }}</h3>
            </div>
        </div>
    </div>
    <div class="col-xxl-3 col-md-6 col-12 dash-info-card super-admin">
        <div class="info-card-inner card mb-0" style="background:none !important;">
            ...
            <div class="info-icon-wrp d-flex flex-wrap align-items-start justify-content-between gap-2 mb-3">
                ...
                <div class="card-label" style="padding: 16px 17px !important;background-color:rgba(104, 57, 79, 0.56) !important;">
                    <!-- {{ __('Government units') }} -->
                </div>
                <div class="card-label" style="font-size: 11px;padding: 0px 15px !important;background-color:rgba(104, 57, 79, 0.56) !important;">
                    9.5%
                </div>
            </div>
            <div class="info-content d-flex align-items-center gap-3 flex-wrap">
                <h2 class="h4 mb-0 info-link" style="color:black !important;">{{ __('Other Units') }}</h2>
                <h3 class="mb-0">{{ $user->total_plan }}</h3>
            </div>
        </div>
    </div>
    <div class="col-xxl-3 col-md-6 col-12 dash-info-card super-admin">
        <div class="info-card-inner card mb-0" style="background:none !important;">
            ...
            <div class="info-icon-wrp d-flex flex-wrap align-items-start justify-content-between gap-2 mb-3">
                ...
                <div class="card-label" style="padding: 16px 17px !important;background-color:rgba(57, 104, 75, 0.56) !important;">
                    <!-- {{ __('Certificate programs') }} -->
                </div>
                <div class="card-label" style="font-size: 11px;padding: 0px 15px !important;background-color:rgba(57, 104, 75, 0.56) !important;">
                    38%
                </div>
            </div>
            <div class="info-content d-flex align-items-center gap-3 flex-wrap">
                <h2 class="h4 mb-0 info-link" style="color:black !important;">{{ __('Certificate Programs') }}</h2>
                <h3 class="mb-0">{{ $user->total_orders }}</h3>
            </div>
        </div>
    </div>
    <div class="col-xxl-3 col-md-6 col-12 dash-info-card super-admin">
        <div class="info-card-inner card mb-0" style="background:none !important;">
            ...
            <div class="info-icon-wrp d-flex flex-wrap align-items-start justify-content-between gap-2 mb-3">
                ...
                <div class="card-label" style="padding: 16px 17px !important;background-color:rgba(104, 58, 57, 0.83) !important;">
                    <!-- {{ __('Pending deployment') }} -->
                </div>
                <div class="card-label" style="font-size: 11px;padding: 0px 15px !important;round-color:rgba(104, 58, 57, 0.83) !important;">
                    99%
                </div>
            </div>
            <div class="info-content d-flex align-items-center gap-3 flex-wrap">
                <h2 class="h4 mb-0 info-link" style="color:black !important;">{{ __('Under Age 18') }}</h2>
                <h3 class="mb-0">{{ $user->total_plan }}</h3>
            </div>
        </div>
    </div>
...
<div class="row mb-5 gy-4">
    <div class="col-xxl-6 col-md-6 col-6 dash-info-card super-admin">
        <div class="info-card-inner card mb-0" style="background:none !important;">
            ...
            <div class="info-content d-flex align-items-center gap-3 flex-wrap">
                <span class="mb-0"">Frequently used admin functions</span>
            </div>
            <div class="card mt-2 mb-1 py-2 px-3" style="background:red; color: white;">Review Application</div>
            <div class="card mb-1 py-2 px-3" style="background:grey; color: white;">Schedule Interview</div>
            <div class="card mb-1 py-2 px-3" style="background:green; color: white;">Create Batch</div>
            <div class="card mb-1 py-2 px-3" style="background:orange; color: white;">Send Notifications</div>
    ...
    <div class="col-xxl-6 col-md-6 col-6 dash-info-card super-admin">
        <div class="info-card-inner card mb-0" style="background:none !important;">
            ...
            <div class="info-content d-flex align-items-center gap-3 flex-wrap">
                <span class="mb-0"">Latest system activities and updates</span>
            </div>
            <div class="card mt-2 mb-1 py-2 px-3">
                125 new applications approved automatically
                <span style="font-size:12px;">2 hours ago</span>
            </div>
            <div class="card mb-1 py-2 px-3">Training Batch NS-2024-Q1 created successfully<span style="font-size:12px;">4 hours ago</span></div>
            <div class="card mb-1 py-2 px-3">45 interviews scheduled for next week<span style="font-size:12px;">6 hours ago</span></div>
            <div class="card mb-1 py-2 px-3">Bulk SMS sent to 200+ students<span style="font-size:12px;">8 hours ago</span></div>
        </div>
    </div>
</div>
